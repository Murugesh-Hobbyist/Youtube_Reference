...
#define POLARGRAPH
  ...
  #define X_MIN_PIN       3  // AUX4_10_PIN
  #define Y_MIN_PIN       14  // E1_DIR_PIN
  #define X_MAX_PIN       2  // AUX4_09_PIN
  #define Y_MAX_PIN       15  // E1_STEP_PIN
  #define Z_MAX_PIN       18  // AUX4_09_PIN
  #define Z_MAX_PIN       19  // E1_STEP_PIN
#endif
...
#define MANUAL_Y_HOME_POS -492.65 //(Y_MAX_POS-( sqrt(sq(POLARGRAPH_MAX_BELT_LEN)-sq(X_BED_SIZE/2))))
