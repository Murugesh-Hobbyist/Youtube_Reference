/*
  ...
  Copyright (C)2015-02018 Rinky-Dink Electronics, Henning Karlsen. All right reserved
...
void UTFT_Geometry::fillTriangle(int32_t x1, int32_t y1, int32_t x2, int32_t y2, int32_t x3, int32_t y3)
{
	int32_t xs, xe;
	int16_t y, ly;
